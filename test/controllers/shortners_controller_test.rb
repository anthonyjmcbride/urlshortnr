...
class ShortnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shortner" do
    assert_difference('Shortner.count') do
      post shortners_url, params: { shortner: { longurl: @shortner.longurl, shorturl: @shortner.shorturl } }
    end
  ...
  test "should update shortner" do
    patch shortner_url(@shortner), params: { shortner: { longurl: @shortner.longurl, shorturl: @shortner.shorturl } }
